...
date = "2026-01-02" 
description = "Recounting my undergraduate experience." 
[taxonomies] 
"writing/tags" = ["blog"] 
[extra]
cover.image = "/images/college-experience/grad_photo.webp"
cover.alt = "Graduation photo."
+++
...
<figure>
    <img src="/images/college-experience/high_school_tree.webp" class="h-16 w-auto">
    <figcaption>The tree my friends sat at for lunch during most of our time, except COVID.</figcaption>
</figure>
...
<figure>
    <img src="/images/college-experience/freshman_room.webp">
...
<figure>
    <img src="/images/college-experience/santa_rosa_sky.webp">
    <figcaption>The location was gorgeous too!</figcaption>
</figure>
...
<figure>
    <img src="/images/college-experience/freshman_jenga.webp" style="width: 50%" >
    <figcaption>The state of a very intense Jenga match. Easily one of the most memorable nights that year.</figcaption>
</figure>

<figure>
    <img src="/images/college-experience/denzel.webp">
    <figcaption>I volunteered for a concert and got to shake Denzel Curry's hand :)</figcaption>
</figure>
...
> Well, try again. I was in a similar position as you, having transferred in my freshman year. What worked for me is I took a few CCS courses, and they liked me enough to let me in. You should do the same. Reach out to the other advisor{{ footnote() }} Karel. Maybe you can take some of his courses.
...
<figure>
    <img src="/images/college-experience/discord_menu.webp">
    <figcaption>One of the features was to incorporate the menus of each dining hall into the bot.</figcaption>
</figure>
...
<figure>
    <img src="/images/college-experience/sophomore_roommates.webp" style="width: 75%">
    <figcaption>Everyday, I wrote a joke on our front door.</figcaption>
</figure>
...
<figure>
    <img src="/images/college-experience/mahjong.webp">
    <figcaption>They taught me how to play Riichi Mahjong. I'm not good at it, but it's very fun.</figcaption>
</figure>

<figure>
    <img src="/images/college-experience/digbar_sophomore.webp">
    <figcaption>Hanging out in Little Tokyo, Los Angeles, with my newfound friends.</figcaption>
</figure>
...
<figure>
    <img src="/images/college-experience/drp_poster.webp" style="width: 75%;">
    <figcaption>Pariya and I presenting our DRP poster.</figcaption>
</figure>
...
After applying, I was selected for an interview. The interview went really well{{ footnote() }}, although I later learned that the then-President left a note saying "friendly and personable, but a bit boring". Ouch. Nevertheless, they accepted me, and I was happy as I felt like I was heading down the right direction. Upon arrival to Data Science UCSB, the technical team was as follows
...
What did this look like? Developing workshop material{{ footnote() }}. We partitioned workshop topics among ourselves and spent most of the summer building them from scratch. 
...
<figure>
    <img src="/images/college-experience/ds_meeting.webp">
...
<figure>
    <img src="/images/college-experience/junior_friends.webp">
    <figcaption>Playing <i>Muffin Time</i> with my friends at tabletop.</figcaption>
</figure>
...
<figure>
    <img src="/images/college-experience/tech_dev.webp">
...
<figure>
    <img src="/images/college-experience/apartment_muffin_time.webp" style="width: 75%;">
...
But alas, six months is not a very long time, and it ended just as quickly as it started. On June 8th, 2025, I finally graduated{{ footnote() }} from UCSB, with a major in mathematics and a minor in statistical sciences. 
...
{% footnote_body() %}
I didn't come up with the original quote. I heard a bastardized version of it on some "never give up" slop and reworked it into something more meaningful. I also recognize how arrogant it is to quote myself, though the material greatly summarizes what I'm trying to say.
{% end %}
